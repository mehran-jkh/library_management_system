...
@Service
public class AccessListServiceImpl extends BaseDTOServiceImpl<AccesslistDTO,Aaaccesslist> implements AccesslistWebService
{
    ...
    {
        super.my_method(AccesslistDTO.class,Aaaccesslist.class);
    }
